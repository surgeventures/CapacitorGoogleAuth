...
export declare type AllowedInitOptions = 'clientId' | 'iosClientId' | 'androidClientId' | 'scopes' | 'serverClientId' | 'forceCodeForRefreshToken';
export interface InitOptions extends Pick<GoogleAuthPluginOptions, AllowedInitOptions> {
    /**
